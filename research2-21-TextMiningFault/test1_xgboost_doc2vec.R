...
write.csv(outputdata, paste(c("result_test1_XGboost_", max_depth, "_", eta, "_doc2vec_", doc2vec_vector_size, "_", doc2vec_window, ".csv"), collapse = ""), row.names = FALSE)